...
###2.1.4 Funkcje z punktu widzenia pracownika Działu Sprzedaży 

* a) Sprzedaż towaru // do konsultacji jesli chodzi o scenariusz

* b) Dodanie raportu o transakcji z klientem

* c) Dodanie notatki o kliencie 

###2.1.5 Funkcje z punktu widzenia pracownika magazynu

* a) Wydanie towaru kierowcy

* b) Wydanie towaru przedstawicielowi handlowemu

* c) Wydanie towaru pracownikowi produkcji

* d) Przeglądanie stanu magazynu

* e) Wprowadzenie do systemu miejsca ułożenia towaru

* f) Odbieranie towaru od kierowcy

* g) Odbieranie towaru od przedstawiciela handlowego

* h) Wydanie towaru do sklepu detalicznego

* i) Meldowanie się w pracy
