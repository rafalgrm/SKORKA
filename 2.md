...
&nbsp; <!--- Zeby sie listy nie mergowaly-->
   ...
   **2.1.3.b)Tytuł: Zaraportowanie wykonania zlecenia**
*   Aktor główny: Pracownik
...
&nbsp; <!--- Zeby sie listy nie mergowaly-->
    ...
    **2.1.4 b)Tytuł: Odebranie materiałów koniecznych do wykonania zadania**
*   Aktor główny: Pracownik działu produkcji
...
&nbsp; <!--- Zeby sie listy nie mergowaly-->
   ...
   **2.1.4 c)Tytuł: Zapisz ukończenia produkcji**
*   Aktor główny: Pracownik działu produkcji
...
<img src="\rysunki\2\Magazyn_razem.png" alt="Magazyn">
   ...
   **Tytuł:2.1.6 a) Wydanie towaru**
*   Aktor główny: Pracownik magazynu
*   Cel: Wysłanie towaru do klienta lub innego magazynu
*   Poziom: Niebieski
*   Gwarancja: Stan systemu nie zmienia się 
*	Warunek początkowy: Zlecenie wysłania przesyłki zostało otrzymane
...
&nbsp; <!--- Zeby sie listy nie mergowaly-->
   ...
   **Tytuł:2.1.6 b) Odebranie materiałów**
*   Aktor główny: Pracownik magazynu
...
&nbsp; <!--- Zeby sie listy nie mergowaly-->
   ...
   **2.1.6 c)Tytuł: Sprawdzanie stanu magazynu**
*   Aktor główny: Pracownik magazynu
